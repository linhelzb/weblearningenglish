...
<body>
		<c:forEach items="${dapandungbtnghe}" var ="dapandung">
						<c:if test="${dapandung.dap_an == 'A'}">
							<c:if test="${kq == 'A'}">
								...
								<p>
									<img src= "Filebtphannghe/${dapandung.hinh_anh}" alt="" style="width:250px;height:150px;"/>
								</p>
								<p>
									<audio controls>
										<source src="Filebtphannghe/${dapandung.file_nghe_ogg}" type="audio/ogg">
										<source src="Filebtphannghe/${dapandung.file_nghe_mp3}" type="audio/mpeg">
									</audio>
								</p>
								<p>
