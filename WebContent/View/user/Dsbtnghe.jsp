...
<body>
	...
	<div class="chua-dung">
	    ...
	    <p>Danh sách bài tập phần nghe</p>
	 	<div class="khoi-nd">
    		
    		<%
		  		if (request.getAttribute("tbdsbtnghe")!=null)
		  		{	  		
		  	%>
		  		<div class="hang">	
						...
						<div>			
								<div>
									 <p style="color:red">${tbdsbtnghe}</p>
								</div>						
						</div>	
	        ...
	        <div class="chitiet">
		        ...
		        <c:forEach items="${danhsachbtnghe}" var="baitapnghe">
		            <div class="bai">
				        
				        <img src="Filebtphannghe/${baitapnghe.anh_bai_tap_nghe}"/>
				        <a href="Lambtnghe?pageid=1&ma_bai_tap_nghe=${baitapnghe.ma_bai_tap_nghe}" type="Xem"><p>${baitapnghe.ten_bai_tap_nghe}</p></a><br>
			...
			<div class="nav">  
				<ul class="pt">
							<c:if test="${numberpage == 1}">
							   ...
							   <li class = "sau"><a href = "Hienthidsbtnghe?pageid=${numberpage+1}"><i class="fas fa-angle-double-right"></i></a></li>
						   </c:if>
						   <c:if test="${numberpage == maxpageid}">
							   <li class = "truoc"><a href = "Hienthidsbtnghe?pageid=${numberpage-1}"><i class="fas fa-angle-double-left"></i></a></li>
