...
public class Hienthidstuvung extends HttpServlet {
			...
			throws ServletException, IOException 
	{
		try 
		{
			...
			List<HuongDanHocTuVung> dstuvung = QuanlyhdtuvungDAO.Hienthidstuvung(request, pageid, count, conn);
			
			
			int sumrow = QuanlyhdtuvungDAO.DemSoHang(conn);
			...
			request.setAttribute("danhsachtuvung",dstuvung);
